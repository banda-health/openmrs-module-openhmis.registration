...
<openmrs:require privilege="Add People" otherwise="/login.htm" redirect="<%= ModuleWebConstants.PAGE_PATIENT_CREATE %>"/>
...
<c:choose>
    <c:when test="${empty param.addName}">
        ...
        <openmrs:portlet id="createPerson" url="addPersonForm"
                         parameters="personType=${param.personType}|postURL=<%= ModuleWebConstants.PAGE_PATIENT_CREATE %>|viewType=${param.viewType}" />
